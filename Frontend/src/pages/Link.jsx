    ...
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      if (user) {
        try {
          ...
          console.log("🔎 found pageData:", found);
  ...
  return (
    <div className="flex flex-col items-center p-6">
      ...
      <a
        ...
        className="w-full max-w-sm p-4 my-2 text-center rounded-lg bg-primary text-white font-semibold shadow-lg hover:bg-primary/90">
        Go to site
      </a>
    </div>
  );
